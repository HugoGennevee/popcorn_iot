            ...
            <div class="card-body">
                ...
                <transition name="fade">
                    ...
                    <div v-else key="dispenser">
                        <h2 class="text-center">Bienvenue <span v-if="nom != null">{{ nom }}</span> !</h2>
...
export default {
    ...
    methods: {
        ...
        dispensePopcorn() {
            if (this.popcornPacks > 0) {
                try {
                    ...
                    axios.post('http://localhost:3000/machine/use', {id: this.abonnement, nbUtilisationsRestantes: this.popcornPacks}, {headers: {'Authorization': `Bearer ${token}`}})
        ...
        requestDataFromCard(id) {
            ...
            axios.post('http://localhost:3000/machine/check', {id: id}, {headers: {skipAuth: true}})
            .then(function (response) {
                responseResult = response.data;
            })
            .catch(function (error) {})
